    ...
    <div className="parent-container">
      <form onSubmit={handleSubmit} className="registration-form">
        ...
        <div className="inline-fields">
          <input type="text" name="Address" placeholder="Address" value={formData.city} onChange={handleChange} required />
        </div>
        <input type="text" name="Address 2" placeholder="Address 2" value={formData.house} onChange={handleChange} required />
