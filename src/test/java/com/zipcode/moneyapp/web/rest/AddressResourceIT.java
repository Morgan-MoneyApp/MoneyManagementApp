...
import static com.zipcode.moneyapp.domain.AddressAsserts.*;
...
class AddressResourceIT {
    ...
    void partialUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.apartmentNumber(UPDATED_APARTMENT_NUMBER).city(UPDATED_CITY).state(UPDATED_STATE).zip(UPDATED_ZIP);
