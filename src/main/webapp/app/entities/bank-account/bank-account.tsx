          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('routingNumber')}>
                  Routing Number <FontAwesomeIcon icon={getSortIconByFieldName('routingNumber')} />
                </th>
                <th className="hand" onClick={sort('balance')}>
                  Balance <FontAwesomeIcon icon={getSortIconByFieldName('balance')} />
                </th>
                <th className="hand" onClick={sort('type')}>
                  Type <FontAwesomeIcon icon={getSortIconByFieldName('type')} />
                </th>
                <th>
                  Account Holder <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {bankAccount.accountHolder ? (
                      <Link to={`/user-profile/${bankAccount.accountHolder.id}`}>{bankAccount.accountHolder.id}</Link>
                    ) : (
                      ''
                    )}
                  </td>
