          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('transactionValue')}>
                  Transaction Value <FontAwesomeIcon icon={getSortIconByFieldName('transactionValue')} />
                </th>
                <th>
            ...
            <tbody>
              {transactionList.map((transaction, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{transaction.source ? <Link to={`/bank-account/${transaction.source.id}`}>{transaction.source.id}</Link> : ''}</td>
                  <td>
                    {transaction.destination ? (
                      <Link to={`/bank-account/${transaction.destination.id}`}>{transaction.destination.id}</Link>
                    ) : (
                      ''
                    )}
                  </td>
